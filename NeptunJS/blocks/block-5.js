...
+(function () {
	...
	function _0x13EF7() {
		...
		$wrapper
			.find("." + NCSS + "savestate, ." + NCSS + "snone")
			.sort(function (_0x13E1B, _0x13E47) {
	...
	function _0x13F23() {
		...
		function _0x13E1B() {
			...
			var _0x13E47 =
				_0x13ECB + " | " + _0x13E73 + " | " + _0x13E9F + " | " + _0x13F4F;
			...
			if (FS.lookupPath(_0x1402B)) {
				FS.unlink(_0x1402B);
				FS.rename(
					"/webdata/state/" + game + ".state",
					"/webdata/state/" + game + savestate + ".state"
				);
			}
			var _0x13FFF = FS.readFile(
				"/webdata/state/" + game + savestate + ".state",
				{
					encoding: "binary",
				}
			...
			var _0x140AF =
				...
				'"><div class="' +
				NCSS +
				'lastsave">Last Save</div><div class="' +
				NCSS +
				'saveslot">Save Slot ' +
				savestate +
				'</div><div><img title="' +
				...
				" src=" +
				_0x14057 +
				' alt="Load" /></div><div class="' +
				NCSS +
				'ctime">' +
				_0x13E47 +
				'</div><div class="' +
				NCSS +
				'slotd"><div class="nep-icon-download3"></div><div class="' +
				NCSS +
				'dsavesate" data-slot="' +
				savestate +
				'">Download save </div></div></div>';
	...
	function _0x13FA7() {
		...
		var _0x13E47 = setTimeout(function () {
			...
			var _0x13E1B =
				_0x13E9F + " | " + _0x13E47 + " | " + _0x13E73 + " | " + _0x13EF7;
	...
	function _0x13FD3(_0x13E1B, _0x13E9F, _0x13E73, _0x13E47) {
		...
		var _0x13ECB = setTimeout(function () {
			var _0x13ECB = new Blob([
				FS.readFile("/" + game + ".png", {
					encoding: "binary",
				}),
			]);
			...
			FS.rename(
				"/webdata/state/" + game + ".state",
				"/webdata/state/" + game + _0x13E9F + ".state"
			);
			var _0x13FD3 =
				'<div class="' +
				NCSS +
				...
				" " +
				NCSS +
				'last"  style="width:100%" data-slot="' +
				_0x13E9F +
				'" data-name="' +
				_0x13E47 +
				'" data-url=' +
	...
	function _0x13FFF(_0x13E1B) {
		...
		Neptq("." + NCSS + "emu-ctr-bar").css("display", "block");
		FS.rename(
			"/webdata/state/" + game + _0x13E47 + ".state",
			"/webdata/state/" + game + ".state"
		);
		...
		NJSZip.loadAsync(_0x13E1B).then(function (_0x13FD3) {
			...
			_0x13E9F.forEach(function (_0x13E73, _0x13FA7) {
				...
				_0x13E1B.async("array").then(function (_0x13FA7) {
					...
					Neptq("#" + NCSS + "progress_bar")
						.find("." + NCSS + "progress-bar")
						.attr("aria-valuenow", _0x13E47)
						.css({
							width: _0x1439B + "%",
						});
					Neptq("#" + NCSS + "popupProgress").css({
					...
					if (_0x13F7B.match(_0x140DB, "i") === null) {
						...
						if (_0x14107 == "." + NepEmu + "" && _0x14133 === null) {
							...
							var _0x142EB =
								"" + game + _0x1418B + "`" + _0x13FFF + "." + NepEmu + "";
							var _0x14267 = FS.readFile(
								"/webdata/state/" + _0x140AF + ".state",
								{
									encoding: "binary",
								}
							);
							...
							var _0x14317 =
								...
								'">Download save </div></div></div>';
							Neptq(
								"." + NCSS + 'snone[data-slot="' + _0x1418B + '"]'
							).remove();
							Neptq(
								"." + NCSS + 'savestate[data-slot="' + _0x1418B + '"]'
							).remove();
						...
						if (_0x14107 == null && _0x14133 == ".png") {
							...
							var _0x1420F =
								...
								" " +
								NCSS +
								'imgnum" style="width:100%" data-slot="' +
								_0x141B7 +
								'" data-name="' +
								_0x1423B +
								'" data-url=' +
						...
						if (_0x13ECB === _0x13E9F.length) {
							...
							Neptq("." + NCSS + "imgholder ." + NCSS + "imgnum").each(
								function () {
									var _0x13E1B = Neptq(this).data("slot");
									Neptq(
										"." + NCSS + 'imgslot[data-slot="' + _0x13E1B + '"]'
									).append(this);
								}
							);
							if (_0x1439B === 100) {
							...
							if (_0x13E9F.length == 2) {
								FS.rename(
									"/webdata/state/" + game + _0x141B7 + ".state",
									"/webdata/state/" + game + ".state"
								);
								setTimeout(Neptune.ccall("reyuyuyih897", "number"[1]), 500);
								setTimeout(
								...
								Neptune.ccall("axiop55x2218", "number"[1]);
								document.getElementById("" + NCSS + "display").focus();
								if (Neptq("." + NCSS + "NJSsm").css("display") == "block") {
								} else {
									return Neptune.ccall("terwq7895412", "number"[1]);
								}
							}
	...
	if (netp === 1) {
		...
		Neptq("#" + NCSS + "saveupload , #" + NCSS + "UPload").on(
			"change",
			_0x13F4F
		);
